...
namespace Lottery.ViewModel.Lobby
{
    ...
    {
        public ObservableCollection<TokenItemViewModel> AvailableTokens { get; set; }

        private TokenItemViewModel _selectedTokenItem;
        public TokenItemViewModel SelectedTokenItem
        {
            get => _selectedTokenItem;
            set
            {
                ...
                {
                    foreach (var item in AvailableTokens) item.IsSelected = false;
        ...
        public SelectTokenViewModel(string currentTokenKey)
        {
            ...
            {
                new TokenItemViewModel { Name = Lang.SelectTokenLabelMarkersBeans, Key = "beans" },
                new TokenItemViewModel { Name = Lang.SelectTokenLabelMarkersBottleCaps, Key = "bottle_caps" },
                new TokenItemViewModel { Name = Lang.SelectTokenLabelMarkersPous, Key = "pou" },
                new TokenItemViewModel { Name = Lang.SelectTokenLabelMarkersCorn, Key = "corn" },
                new TokenItemViewModel { Name = Lang.SelectTokenLabelMarkersCoins, Key = "coins" },
            };
